  ...
  (function ( $ ) {
    var image_plugin = {
      ...
      set_scroll_number_in_footer : function(size, visible) {
        ...
        $('#active').css({'width': (visible * 35) + 'px', 'right': (right_position * 37.5) + 'px'});
        $('a').addClass('footer');
      },
      ...
      image_movement : function(visible, size, current_position, width) {
        ...
        if (current_position > (size - parseInt(visible, 10))) {
          ...
          $('#active').css({'width': (visible * 35) + 'px', 'right': '150px'});
          current_object.last_position = current_position;
      ...
      scroll_movement : function(current_position, size, visible) {
        ...
        if (current_position > (size - parseInt(visible, 10))) {
          for(var i = 0; i < visible; i++) {
            if (current_position === "" + ((parseInt(size,10) - i)) || current_position === ((parseInt(size,10) - i))) {
              if (current_object.first_click_scroll === 0) {
                if(current_object.last_position == 0) {
                  scroll_position = (((parseInt(current_position, 10) - (parseInt(visible) - i)) - parseInt(current_object.last_position, 10)) * 36) + parseInt(current_position, 10) + visible;
                } else {
          ...
          scroll_position = (parseInt(current_position, 10) - 1) * 34.6 + parseInt(current_position, 10);
          ...
          current_object.first_click_scroll = 0;
          scroll_position = (parseInt(current_position, 10) - (parseInt(current_object.last_position, 10))) * 36;
        }
